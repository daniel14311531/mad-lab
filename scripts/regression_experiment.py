...
def get_args():
    ...
    # logging: 
    parser.add_argument('--logs-path', type=str, default='./logs/ogd-experiment', help='path where individual training run logs are stored')
...
def run_sweep(
    ...
    num_cpus_trial: int = 4,
    logs_path: str = './logs/ogd-experiment',
    ...
    mad_scores = []
    layer_methods = ['mh-o2b-deltanet', 'mh-o2b-weighted-deltanet', 'mh-gla-naive', 'mh-least-square']
    name_map = {
        'mh-o2b-deltanet': 'MH O2B Deltanet',
        'mh-o2b-weighted-deltanet': 'MH O2B Weighted Deltanet',
        'mh-gla-naive': 'MH Gla Naive',
        'mh-least-square': 'MH Least Square'
    }
    for ogd_method in layer_methods:
